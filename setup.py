...
SPLUNKAPP_BASE_DIR = "DCSO_TIE_App" + str(VERSION.major)
# SPLUNKAPP_DISTNAME is the filename of the distribution
SPLUNKAPP_DISTNAME = "DCSO_TIE_Splunk_App" + str(VERSION.major)
...
setup(name='dcso_tie_splunk_app',
      version=__version__,
      description="DCSO Threat Intelligence Engine (TIE) App for Splunk 8.0",
      author='DCSO GmbH',
